...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Lot.auction'
        db.delete_column('auction_lot', 'auction_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Lot.auction'
        raise RuntimeError("Cannot reverse this migration. 'Lot.auction' and its values cannot be restored.")
