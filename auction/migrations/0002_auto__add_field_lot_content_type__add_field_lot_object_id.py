...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lot.content_type'
        db.add_column('auction_lot', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Lot.object_id'
        db.add_column('auction_lot', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lot.content_type'
        db.delete_column('auction_lot', 'content_type_id')

        # Deleting field 'Lot.object_id'
        db.delete_column('auction_lot', 'object_id')
