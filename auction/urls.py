...
urlpatterns = patterns('',
    ...
    url(r'^(?P<slug>[0-9A-Za-z-_.]+)/$', auction.views.AuctionView.as_view(), name='auction'),
    url(r'^(?P<auction_slug>[0-9A-Za-z-_.]+)/lot/(?P<slug>[0-9A-Za-z-_.//]+)/(?P<pk>\d+)/$', auction.views.LotDetailView.as_view(), name='lot'),
)